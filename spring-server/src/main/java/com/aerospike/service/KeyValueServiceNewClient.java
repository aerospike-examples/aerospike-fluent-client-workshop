...
public class KeyValueServiceNewClient implements KeyValueServiceInterface {
    ...
    public KeyValueServiceNewClient(ClientConfiguration config) {
        // Enhanced client policy with optimizations for new client
        ClientPolicy clientPolicy = new ClientPolicy();
        clientPolicy.timeout = 5000; // 5 second timeout
        clientPolicy.maxConnsPerNode = 100; // Increased connection pool
        clientPolicy.connPoolsPerNode = 2; // Multiple connection pools
